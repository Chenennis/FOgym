...
days = floor(40/par);%number of days for iteration
...
for counter = 1:Length
    ...
    %showing cases where imbalance prices are high
    aa = (N-M > dif);
    bb = find(aa == 1);
    M1 = M(bb);
    N1 = N(bb);
...
%              end
    ...
    if cloud == 1
        filename = sprintf("/home/ubuntu/5DFOswitching%d_%d_%d_%d_%d.xlsx",T,NumBatteries,dif,parallel,pt1);
    else
